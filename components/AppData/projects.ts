...
const PROJECTS_DATA = [
  {
    ...
    about: '2021 – present\nLed website rebranding, creating visually appealing designs with Lottie animations, integrating Calendly, and developing over 30 pages. Enhanced user engagement and functionality through text-based animations (AOS), performance optimization, and SEO. Implemented Google Analytics and Ahref for comprehensive analytics, driving increased traffic and user interaction.',
    link: 'https://stead.global',
    imageUrl: '/projects/stead-website-1.gif',
    type: ['others', 'project'],
    technologies: ['React.js', 'Lottie', 'Calendly', 'AOS', 'SEO', 'Google Analytics', 'Ahref'],
  },
  {
    title: 'Kipe.co',
    description: 'Track, Invoice and CRM',
    about: '2020 – present\nLed end-to-end frontend development, including website creation, SEO optimization, and API integration using Axios. Implemented Stripe for payments, migrated from webpack to Vite bundler, and customized the Material UI library. Developed additional features, including Kipe Invoice and ongoing work on Kipe CRM. Enhanced user experience and performance, contributing to increased engagement and satisfaction. Delivered a robust, optimized frontend with seamless real-time updates and payment processing.',
    link: 'https://kipe.co',
    imageUrl: '/projects/kipeco.png',
    type: ['others', 'project'],
    technologies: ['React', 'SASS', 'Stripe', 'WebSocket', 'Django', 'Python', 'Gatsby', 'PostgreSQL'],
  },
  {
    title: 'Inquest AI',
    description: 'Full-Stack Developer at Inquest AI',
    about: '2023 May – present\nLed end-to-end development, including website creation and SEO optimization using Next.js, and developed APIs with Django. Focused on bug fixing, implementing client feedback, and adding new modules, ensuring seamless frontend and backend integration. Improved website performance, SEO rankings, and API operations, enhancing user engagement and satisfaction.',
    link: 'https://inquestai.com',
    imageUrl: '/projects/inquestai.png',
    type: ['others', 'project'],
...

  {
    ...
    link: 'https://goodcode.us',
    imageUrl: '/projects/goodcode.png',
    type: ['others', 'project'],
...

  {
    ...
    imageUrl: '/projects/lightgallery.png',
